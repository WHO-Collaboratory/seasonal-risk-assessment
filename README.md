...
**Get started:** [Download the Excel workbook](https://raw.githubusercontent.com/WHO-Collaboratory/seasonal-risk-assessment/main/data/WHO%20Seasonal%20Risk%20Assessment%20Tool%20%28TEMPLATE%29.xlsx) · [Download a worked example](https://raw.githubusercontent.com/WHO-Collaboratory/seasonal-risk-assessment/main/data/WHO%20Seasonal%20Risk%20Assessment%20Tool%20%28EXAMPLE%29.xlsx) · [Go to the Shiny app](https://worldhealthorg.shinyapps.io/seasonal-risk-assessment/)

This tool provides a quantitative framework for assessing public health risk related to extreme temperature conditions in acute emergency settings. It supports operational preparedness and response planning across different climates and seasonal contexts, applying a composite indicator methodology structured around three pillars of Exposure, Vulnerability, and Coping Capacity to produce relative risk scores across subnational areas within a single assessment. It is intended primarily for national ministries of health and public health authorities responsible for seasonal preparedness and response planning, supported by WHO country offices and technical partners.
...
│   └── WHO Seasonal Risk Assessment Tool (EXAMPLE).xlsx           Filled-in example workbook, kept for reference
├── www
│   ├── who-logo.png                                               Logo used in the app header
│   ├── WHO Seasonal Risk Assessment Tool Shiny App.png            Screenshot of the app, used in this README
